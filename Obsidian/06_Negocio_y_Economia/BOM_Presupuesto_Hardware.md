...
Este documento detalla la Lista de Materiales (BOM - *Bill of Materials*) para fabricar la infraestructura hardware del proyecto. El objetivo es validar si es posible mantener el costo total de fabricación del equipamiento en un rango de **500 € a 600 €**, y proyectar los márgenes para la estrategia de "masificación".
...
| :--- | :--- | :--- |
| **Heltec WiFi LoRa 32 V4** | Microcontrolador principal + Transceptor SX1262 LoRa | ~ 40.00 € |
| **Sensor de Suelo 7-en-1** | Sonda RS485 (NPK, Humedad, Temperatura, EC, pH) | ~ 41.00 € |
| **Adaptadores (RS485 y Voltaje)** | Módulo HW-726 (RS485 a TTL) + MT3608 (Step-Up a 12v) | ~ 3.50 € |
| **Energía Autónoma** | Panel Solar (5V 1W/2W) + 2x Baterías 18650 + BMS | ~ 20.00 € |
| **Protección IP68** | Caja estanca, prensaestopas, resina epóxica para aislar empates | ~ 15.00 € |
| **Total por Nodo Físico** | | **~ 120.00 €** |
...
| Componente | Descripción | Costo Estimado (Unitario) |
| :--- | :--- | :--- |
| **Heltec WiFi LoRa 32 V4** | Receptor LoRa (Escucha continua sin Deep Sleep) | ~ 40.00 € |
...
- 1x Nodo Emisor: 120 €
- 1x Nodo Receptor (Gateway): 75 €
- 1x CPU Edge AI (8GB RAM, 128GB SSD): 350 €
- **Costo Fabricación: ~ 545 €** (Cumple perfectamente con la meta de estar por debajo de los 600 €).

### Escenario B: Paquete Óptimo (2 Emisores + 1 Receptor + CPU Edge)
- 2x Nodos Emisores (2 * 120 €): 240 €
- 1x Nodo Receptor (Gateway): 75 €
- 1x CPU Edge AI (8GB RAM, 128GB SSD): 350 €
- **Costo Fabricación: ~ 665 €** (Excede en 65 del margen de 600 €, si se entrega 2 puntos de medición en campo).
...
- 10x Nodos Emisores: ~ 1200 €
- 1x Nodo Receptor (Gateway): 75 €
- 1x CPU Edge AI (8GB RAM, 128GB SSD): 350 €
- **Costo de Fabricación (BOM Total): ~ 1.625 €**

> [!tip] Ventaja Comercial y Masificación
> La competencia cobra alrededor de **10.000 € por 2 estaciones**. Nuestro costo de fabricación por un ecosistema autónomo con **10 estaciones + IA Local** es de **1.625 €**. 
> Si se vende este sistema masivo a **10.000 €**, entrega un valor tecnológico abismalmente superior (Edge AI propio, sin pagos mensuales en la nube, y 5 veces más cobertura territorial) manteniendo un **margen de ganancia bruto cercano al ~83,75% (~8.375 € de beneficio por instalación)**.
